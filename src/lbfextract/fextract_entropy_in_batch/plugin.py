...
class CliHook:
    ...
    def get_command(self) -> click.Command:
        @click.command(short_help="It extracts the entropy signal from a BAM file for each BED file provided.")
        ...
        def extract_entropy_in_batch(path_to_bam: pathlib.Path, path_to_bed: pathlib.Path,
            ...
            App(plugins_name=["entropy_in_batch",
        ...
        return extract_entropy_in_batch
